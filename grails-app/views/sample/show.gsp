	...
	<body>
		...
		<div id="show-sample" class="content scaffold-show" role="main">
			...
			<ol class="property-list sample">
				...
				<g:if test="${sampleInstance?.info}">
				<li class="fieldcontain">
					<span id="info-label" class="property-label"><g:message code="sample.info.label" default="Info" /></span>
					
						<span class="property-value" aria-labelledby="info-label"><g:fieldValue bean="${sampleInstance}" field="info"/></span>
