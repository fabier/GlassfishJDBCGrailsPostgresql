			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="info" title="${message(code: 'sample.info.label', default: 'Info')}" />
				...
				<g:each in="${sampleInstanceList}" status="i" var="sampleInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${sampleInstance.id}">${fieldValue(bean: sampleInstance, field: "info")}</g:link></td>
